...
> Generated navigation only. `PROJECT.md` is authoritative for current workflow state.
...
- [F001 — Homepage and Global Navigation](features/F001-homepage-global-navigation.md)
- [F002 — Catalogue Browsing and Search](features/F002-catalogue-browsing-search.md)
- [F003 — Product Detail Experience](features/F003-product-detail-experience.md)
- [F004 — Shopping Cart](features/F004-shopping-cart.md)
- [F005 — Checkout, Address and Order Creation](features/F005-checkout-address-order-creation.md)
- [F006 — Razorpay Test Payment and Order Confirmation](features/F006-razorpay-test-payment-order-confirmation.md)
- [F007 — Customer Authentication, Account and Order History](features/F007-customer-authentication-account-order-history.md)
- [F008 — Ceiling Catalogue and Consultation Request](features/F008-ceiling-catalogue-consultation-request.md)
- [F009 — Admin Access and Catalogue Management](features/F009-admin-access-catalogue-management.md)
- [F010 — Admin Order and Ceiling Enquiry Operations](features/F010-admin-order-ceiling-enquiry-operations.md)
- [F011 — MVP Experience Quality and Release Acceptance](features/F011-mvp-experience-quality-release-acceptance.md)
...
- [Approved System Architecture](docs/architecture/SYSTEM-ARCHITECTURE.md)
- [Approved Data Model](docs/architecture/DATA-MODEL.md)
