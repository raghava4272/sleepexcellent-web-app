...
4. Checkout collects the minimum customer and delivery information needed for an India-only order: customer name, email, phone, address lines, city, state, and PIN code.
